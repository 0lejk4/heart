...
const badges = [
    {
        name: 'Scaladex',
        link: `https://index.scala-lang.org/jap-company/heart/${variables.coreModuleName}`,
        src: `https://index.scala-lang.org/jap-company/heart/${variables.coreModuleName}/latest-by-scala-version.svg?platform=jvm`,
    },
    {
        name: 'Maven Central',
    ...
    {
        name: 'CI',
        link: `https://github.com/jap-company/heart/actions?query=workflow%3A%22CI%22`,
        src: `https://github.com/jap-company/heart/workflows/CI/badge.svg`,
    },
]
...
export default function Home() {
          ...
          <span className={styles.projectName}>
            ...
            <h1>{siteConfig.title}</h1>
                ...
                <div className={styles.quicklinks}>
                    ...
                    <Link href={`${siteConfig.url}${siteConfig.baseUrl}${siteConfig.customFields.apiUrl}/`}
            ...
            <main className={styles.mainContainer}>
                <div className={styles.index}>
                    ...
                    <p>To get started with <Link href="https://scala-sbt.org">sbt</Link>, simply add the following line
                        to your `build.sbt` file.</p>
  ...
  "${variables.organization}" %% "${variables.catsModuleName}" % "${variables.version}",
                    ...
                    <p>Published for Scala {variables.scalaPublishVersions}. For changes, refer to the <Link
                        href="https://github.com/jap-company/heart/releases">release notes</Link>.</p>
